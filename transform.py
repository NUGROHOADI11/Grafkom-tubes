...
# translate_button1 = tk.Button(window, text="Translate Up", command=lambda: translate(0, -20))
# translate_button1.pack()
# translate_button2 = tk.Button(window, text="Translate Down", command=lambda: translate(0, 20))
# translate_button2.pack()
# translate_button3 = tk.Button(window, text="Translate Left", command=lambda: translate(-20, 0))
# translate_button3.pack()
# translate_button4 = tk.Button(window, text="Translate Right", command=lambda: translate(20, 0))
